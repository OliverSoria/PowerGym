...
public class Consulta extends JFrame implements ActionListener {
	...
	void myConsultarEmpleados(String identificador) {
		...
		// Medias del boton
		cerrar.setBounds(240, 320, 80, 30);
        ...
        try {
            ...
            String sql = "select Nombre, Apellido, Telefono, Direccion, Correo, Usuario from " + tablaDB;
        ...
        // Medidas de la tabla
		scrollPane.setBounds(50, 20, 500, 260);								
